	  	...
	  	<div class="navigation">	
  			<div class="bestcandidatedetails">				
				...
				<div class="bestcandidatedetailstext">
					<div class="bestcandidatenumber">					
						<c:out value="${cand1.id}"/>
					</div>					
					<div class="bestcandidatetext">					
						<c:out value="${cand1.surname} ${cand1.firstname}"/><br>
						<c:out value="${cand1.party}"/>
					</div>				
			...
			<div class="navigation">
				<div class="bestcandidatedetails">
					...
					<div class="bestcandidatedetailstext">	
						<div class="bestcandidatenumber">					
							<c:out value="${cand2.id}"/>
						</div>				
						<div class="bestcandidatetext">						
							<c:out value="${cand2.surname} ${cand2.firstname}"/><br> 							
							<c:out value="${cand2.party}"/>
						</div>				
						<div class="bestcandidatevalue">	 
			...
			<div class="navigation">
				<div class="bestcandidatedetails">
					...
					<div class="bestcandidatedetailstext">
						<div class="bestcandidatenumber">					
							<c:out value="${cand3.id}"/>
						</div>						
						<div class="bestcandidatetext">						
							<c:out value="${cand3.surname} ${cand3.firstname}"/><br>
							<c:out value="${cand3.party}"/>
						</div>
						<div class="bestcandidatevalue">						
			...
			<div class="navigation">
				<div class="bestcandidatedetails">
					...
					<div class="bestcandidatedetailstext">
						<div class="bestcandidatenumber">					
							<c:out value="${cand4.id}"/>
						</div>					
						<div class="bestcandidatetext">								
							<c:out value="${cand4.surname} ${cand4.firstname}"/><br>
							<c:out value="${cand4.party}"/>
						</div>
						<div class="bestcandidatevalue">
			...
			<div class="navigation">
				<div class="bestcandidatedetails">
					...
					<div class="bestcandidatedetailstext">
						<div class="bestcandidatenumber">					
							<c:out value="${cand5.id}"/>
						</div>
						<div class="bestcandidatetext">	
							<c:out value="${cand5.surname} ${cand5.firstname}"/><br>
							<c:out value="${cand5.party}"/>
						</div>
						<div class="bestcandidatevalue">
